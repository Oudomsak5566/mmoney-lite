...
class ResultQrPaymentScreen extends StatelessWidget {
  final Response res;
  const ResultQrPaymentScreen({super.key, required this.res});
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Center(
                                                      child: Text(
                                                        '- ${NumberFormat('#,###').format(double.parse(res.data["transAmount"]))}',
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            '- ${NumberFormat('#,###').format(double.parse(res.data["fee"]))}',
                                                            style: GoogleFonts.poppins(
                                                                fontSize: 14, color: Style.dark, fontWeight: FontWeight.w500),
                                                          ),
                                                        ],
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.of(context)
                                .pushAndRemoveUntil(MaterialPageRoute(builder: (c) => const BottomNavScreen()), (route) => false);
                          },
  ...
  Container buildOperationLogo() {
    return Container(
      child: Column(
        children: [
          Text("QR PAYMENT", style: Style.headLineStyle1Black),
          SizedBox(
            height: 150,
